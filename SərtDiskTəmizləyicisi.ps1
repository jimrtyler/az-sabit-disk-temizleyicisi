...
#GUI Variables
$FormTitleText = "Cim Tayler tərəfindən Disk Təmizləyicisi (PowerShellEngineer.com)"
$SelectDiskLabelText = "Disk seçin:"
$FreeSpaceLabelText = "Boş yer (giqabayt): "
$TotalSpaceLabelText = "Ümumi boşluq (giqabayt): "
$JunkFoundLabelText = "Tapılan zibil (giqabayt):"
$CleanDiskBtnText = "Diski təmizləyin *Faylları silir*"
$SpaceCleanedLabelText = "Boşluq təmizləndi (giqabayt): "
$LogFileLabelText = "Log faylı yerləşir: $abcdefg"
$CreditLabelText = "Jim Tyler tərəfindən skript - PowerShellEngineer.com"
$LogFileLocatedText = "Log faylı yerləşir"
$AnalyzingDriveText = "Sürücülər təhlil edilir..."
$BrowsersAreRunningText = "Brauzerlər işləyir... istifadəçiyə məlumat verilir..."
$PleaseCloseBrowsersText = "Lütfən, bütün veb brauzerləri bağlayın və yenidən cəhd edin."
$CleaningDriveText = "Sürücü təmizlənir..."
